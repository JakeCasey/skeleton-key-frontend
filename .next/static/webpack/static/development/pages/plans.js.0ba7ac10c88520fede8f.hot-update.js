...
function (_React$Component) {
  ...
  function Subscribe() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onToken", function (token, subscribe) {
      console.log(token); // fetch('/save-stripe-token', {
      //     method: 'POST',
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          __self: this
        }, plan.planId), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_stripe_checkout__WEBPACK_IMPORTED_MODULE_2___default.a, {
          name: planId,
          description: description,
          token: function token(_token) {
            return _this2.onToken(_token, subscribe);
          },
...
//# sourceMappingURL=plans.js.0ba7ac10c88520fede8f.hot-update.js.map