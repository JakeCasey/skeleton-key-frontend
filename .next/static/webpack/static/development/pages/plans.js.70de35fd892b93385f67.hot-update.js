...
var SUBSCRIBE_USER_MUTATION = graphql_tag__WEBPACK_IMPORTED_MODULE_4___default()(_templateObject());
...
function (_React$Component) {
  ...
  function Subscribe() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onToken", function (token, planId, subscribe) {
      console.log(token);
      console.log(planId); // fetch('/save-stripe-token', {
      //     method: 'POST',
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          __self: this
        }, planId), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_stripe_checkout__WEBPACK_IMPORTED_MODULE_2___default.a, {
          name: planId,
          description: description,
          token: function token(_token) {
            return _this2.onToken(_token, planId, subscribe);
          },
          stripeKey: _config__WEBPACK_IMPORTED_MODULE_3__["STRIPE_PUBLIC_KEY"],
          __source: {
            fileName: _jsxFileName,
            lineNumber: 43
          },
...
//# sourceMappingURL=plans.js.70de35fd892b93385f67.hot-update.js.map