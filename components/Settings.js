	...
	return (
		<div className="space-y-6 page-content">
			...
			<div className="space-y-4">
				...
				{me.customerId && (
					<form action={`${endpointUrl}/create-customer-portal-session`} method="POST">
			...
			<div className="ds-section">
				<div className="flex space-x-1">
					...
					<a className="pill" href="https://mydirigible.com/legal/terms-and-conditions/">
						<span>Terms & Conditions</span>
					</a>
					<a className="pill" href="https://mydirigible.com/legal/privacy-policy/">
